...
if read_fill_info:
  ...
  #t2 = pd.Timestamp(df_current[df_current['HX:BMODE'] == mode[-1]].index[0], tz='UTC')
  #t1 = pd.Timestamp(df_current[df_current['HX:BMODE'] == 'INJPHYS'].index[0], tz='UTC')
  #t2 = pd.Timestamp(df_current[df_current['HX:BMODE'] == 'BEAMDUMP'].index[0], tz='UTC')

else:
  #t1 = pd.Timestamp('2023-03-29 14:30:42.874738525', tz = 'CET')
  #t2 = pd.Timestamp('2023-03-29 14:47:32.591238525', tz = 'CET')
